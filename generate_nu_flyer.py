...
customers to leave a 5-star Expedia review. Embeds a QR code pointing to
the NU landing page that walks customers through finding their survey email.
"""
...
OUT_PATH = "nu-expedia-review-flyer.pdf"
LANDING_URL = "https://alvarocabezali-cell.github.io/NU-SURVEY-PAGE/"
...
def main():
    ...
    c.setTitle("NU Car Rentals — Leave us a review on Expedia")
    ...
    c.drawCentredString(page_w / 2, 4.5 * mm, "Thank you for choosing NU Car Rentals")
